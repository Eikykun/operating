...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodDecorationAppContainer) DeepCopyInto(out *PodDecorationAppContainer) {
	*out = *in
	if in.Image != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodDecorationAppContainer.
func (in *PodDecorationAppContainer) DeepCopy() *PodDecorationAppContainer {
	if in == nil {
		return nil
	}
	out := new(PodDecorationAppContainer)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodDecorationContainer) DeepCopyInto(out *PodDecorationContainer) {
	*out = *in
	if in.Container != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodDecorationContainer.
func (in *PodDecorationContainer) DeepCopy() *PodDecorationContainer {
	if in == nil {
		return nil
	}
	out := new(PodDecorationContainer)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodDecorationInjectionStrategy) DeepCopyInto(out *PodDecorationInjectionStrategy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodDecorationInjectionStrategy.
func (in *PodDecorationInjectionStrategy) DeepCopy() *PodDecorationInjectionStrategy {
	if in == nil {
		return nil
	}
	out := new(PodDecorationInjectionStrategy)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodDecorationPodTemplateSpec) DeepCopyInto(out *PodDecorationPodTemplateSpec) {
	*out = *in
	if in.InitContainers != nil {
		in, out := &in.InitContainers, &out.InitContainers
		*out = make([]*PodDecorationContainer, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PodDecorationContainer)
	...
	if in.AppContainers != nil {
		in, out := &in.AppContainers, &out.AppContainers
		*out = make([]*PodDecorationAppContainer, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PodDecorationAppContainer)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodDecorationPodTemplateSpec.
func (in *PodDecorationPodTemplateSpec) DeepCopy() *PodDecorationPodTemplateSpec {
	if in == nil {
		return nil
	}
	out := new(PodDecorationPodTemplateSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodDecorationStatus) DeepCopyInto(out *PodDecorationStatus) {
	*out = *in
	...
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]PodDecorationCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
